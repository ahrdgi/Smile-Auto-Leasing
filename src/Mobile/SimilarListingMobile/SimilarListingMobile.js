...
import './SimilarListingMobile.css';
...
const SimilarListingMobile = (props) => {
    return (
        <StyledListing className="MobileSimilarListing">
            <Link to={props.dynlink} onClick={props.mount}><StyledImg src={props.imageSrc} alt="IMAGE COMING SOON"/></Link>
            <div className="MobileSimilarListingDivider"/>
            <div className="MobileSimilarListingInfo">
                <p>{props.year} {props.make}<br/>{props.model}</p>
                <p className="MobileSimilarListingFrom">From:</p>
                <p className="MobileSimilarListingPrice">{props.price}</p>
...
export default SimilarListingMobile;